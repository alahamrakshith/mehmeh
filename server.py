...
@app.route('/register')
def register():
    return render_template('register.html', template_folder="templates")

@app.route('/dashboard')
def dashboard():
    return render_template('dashboard.html', template_folder="templates")
...
def predict():
    ...
    try:
        ...
        return render_template('dashboard.html',quote=quote,arima_pred=round(arima_pred,2),lstm_pred=round(lstm_pred,2),
                               ...
                               tw_list="",tw_pol="",idea="",decision="",high_s=today_stock['High'].to_string(index=False),
